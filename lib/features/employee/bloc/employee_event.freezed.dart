...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initialize value)?  initialize,TResult Function( _FetchTasks value)?  fetchTasks,TResult Function( _FilterTasks value)?  filterTasks,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initialize value)  initialize,required TResult Function( _FetchTasks value)  fetchTasks,required TResult Function( _FilterTasks value)  filterTasks,}){
final _that = this;
switch (_that) {
case _Initialize():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initialize value)?  initialize,TResult? Function( _FetchTasks value)?  fetchTasks,TResult? Function( _FilterTasks value)?  filterTasks,}){
final _that = this;
switch (_that) {
case _Initialize() when initialize != null:
return initialize(_that);case _FetchTasks() when fetchTasks != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initialize,TResult Function( String employeeId)?  fetchTasks,TResult Function( String employeeId,  String priority)?  filterTasks,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initialize() when initialize != null:
...
return filterTasks(_that.employeeId,_that.priority);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initialize,required TResult Function( String employeeId)  fetchTasks,required TResult Function( String employeeId,  String priority)  filterTasks,}) {final _that = this;
switch (_that) {
case _Initialize():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initialize,TResult? Function( String employeeId)?  fetchTasks,TResult? Function( String employeeId,  String priority)?  filterTasks,}) {final _that = this;
switch (_that) {
case _Initialize() when initialize != null:
return initialize();case _FetchTasks() when fetchTasks != null:
return fetchTasks(_that.employeeId);case _FilterTasks() when filterTasks != null:
