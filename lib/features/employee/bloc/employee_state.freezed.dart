...
class _Initial implements EmployeeState {
  const _Initial();
...
class _Loading implements EmployeeState {
  const _Loading();
...
class _Loaded implements EmployeeState {
  const _Loaded({required final  List<Task> tasks}): _tasks = tasks;
...
@override
String toString() {
  return 'EmployeeState.loaded(tasks: $tasks)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $EmployeeStateCopyWith<$Res> {
...
class _Error implements EmployeeState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $EmployeeStateCopyWith<$Res> {
