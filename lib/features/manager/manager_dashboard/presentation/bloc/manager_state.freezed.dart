...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ManagerState);
}
...
/// @nodoc
class $ManagerStateCopyWith<$Res>  {
$ManagerStateCopyWith(ManagerState _, $Res Function(ManagerState) __);
}


/// Adds pattern-matching-related methods to [ManagerState].
extension ManagerStatePatterns on ManagerState {
...
class _Initial implements ManagerState {
  const _Initial();
...
class _Loading implements ManagerState {
  const _Loading();
...
class _Loaded implements ManagerState {
 ...
 final  List<UserProfile> _employees;
 List<UserProfile> get employees {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ManagerStateCopyWith<$Res> {
...
class _Error implements ManagerState {
...
@override
String toString() {
  return 'ManagerState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ManagerStateCopyWith<$Res> {
